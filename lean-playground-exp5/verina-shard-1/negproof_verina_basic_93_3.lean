...
-- After simplification, we need to show the negation of the postcondition
-- The implementation computes: temp = 1 ^^^ 2 = 3, newY = 3 ^^^ 2 = 1, newX = 3 ^^^ 1 = 2
-- So it returns (1, 2) instead of (2, 1)
simp only [UInt8.xor_def]
norm_num
