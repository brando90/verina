...
theorem SwapBitvectors_spec_violated : ∃ X Y,
  ...
  use 1, 2, trivial
simp only [SwapBitvectors_postcond, SwapBitvectors, not_and, ne_eq]
left
-- The implementation returns (1, 2) but should return (2, 1)
-- We need to show result.fst ≠ Y, i.e., 1 ≠ 2
norm_num
