...
use trivial
intro h_post
-- The specification says for input with invalid digits, result should be []
-- '1' is not in the valid digit set ['2','3','4','5','6','7','8','9']
...
-- Since "1" is not empty and contains invalid digit, postcondition says result = []
...
-- The combine function processes ['1'] with initial acc = [""]
-- Since '1' is not in mapping, it returns acc unchanged = [""]
-- So h_post states [""] = [], which is false
exact List.cons_ne_nil "" []
