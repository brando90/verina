...
intro h
-- Show that 16 % 8 = 0
have div_by_8 : (16 : Int) % 8 = 0 := by norm_num
-- Show that the left side of the biconditional is true
...
-- But isItEight 16 is false (16 has digits 1 and 6, no 8)
have is_false : isItEight 16 trivial = false := by rfl
-- This is a contradiction
rw [is_false] at should_be_true
exact Bool.noConfusion should_be_true
