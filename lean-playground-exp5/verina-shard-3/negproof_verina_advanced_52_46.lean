...
-- But reverse [1, 2, 3] = [3, 2, 1], and we need to take 2 elements to get both 1 and 2
...
have rev_eq : List.reverse [1, 2, 3] = [3, 2, 1] := by decide
rw [rev_eq]
have take_eq : List.take 1 [3, 2, 1] = [3] := by decide
rw [take_eq]
