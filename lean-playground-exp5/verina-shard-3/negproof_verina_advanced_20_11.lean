...
intro h
-- The specification says: (16 % 8 = 0 ∨ ∃ i, 16 / 10^i % 10 = 8) ↔ isItEight 16 trivial
-- We know 16 % 8 = 0
have left_true : 16 % 8 = 0 ∨ ∃ i, Int.natAbs 16 / 10 ^ i % 10 = 8 := by
  left
  norm_num
-- By the biconditional, isItEight 16 trivial must be true
have right_must_be_true : isItEight 16 trivial = true := h.mp left_true
-- But isItEight 16 returns false (16 has digits 1 and 6, no 8)
have right_is_false : isItEight 16 trivial = false := by
  native_decide
-- This is a contradiction
rw [right_is_false] at right_must_be_true
cases right_must_be_true
