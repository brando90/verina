...
simp [List.reverse, List.take, List.all, List.elem]
-- minOperations returns 1 (counting element 1 < 2)
-- But taking 1 element from reversed [2,1] = [1,2] gives [1]
-- This doesn't contain 2, so collected_all is false
decide
