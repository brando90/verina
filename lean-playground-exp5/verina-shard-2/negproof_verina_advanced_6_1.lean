...
theorem allVowels_spec_violated : ∃ s,
  ...
  use "a"
use trivial
simp only [allVowels_postcond, allVowels]
simp only [normalize_str, String.toList, List.all, List.contains, List.mem]
simp only [Char.isAlpha, decide, Bool.not_eq_true', Bool.decide_eq_false, List.elem]
rfl
